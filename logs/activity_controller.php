...
require_once($_SERVER['DOCUMENT_ROOT']."/libraries/class.activity.php");
...
echo $handle;
*/
/*daniela$handle = fopen($my_file, 'w') or die('Cannot open file:  '.$my_file);
$data = $xml;
fwrite($handle, $data);
